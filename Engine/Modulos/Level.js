class World {
    ...
    vectorX (capa, x, y) {
        ...
        switch (capa) {
            case 1:
                dataCapa = this.dataMapCapa("./Motor/Modulos/Maps/"+ this.world[Math.floor(y / this.tileSize)][x] +".json");
    ...
    getMap (width, height, posPlayer, posMap) {
        let capa1 = this.desingMapCapa(width, height, this.mapCapaOne, posPlayer, posMap),
            ...
            capaCollision = this.desingMapCollision(width, height, this.mapCapaCollision, posPlayer, posMap);
